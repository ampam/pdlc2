...
public:
    ...
    virtual std::string JsGenerator::doNamespace( ast::NamespaceNode const& astNode ) override;
protected:
    ...
    virtual std::string visitAttrRequiredParams( ast::AttrRequiredParams const& astAttrRequiredParams) override;
