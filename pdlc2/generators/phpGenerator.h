...
protected:
    ...
    virtual std::string visitAttrOptionalParams( ast::AttrOptionalParams const& astAttrRequiredParams) override;
    virtual std::string visitAttrRequiredParams( ast::AttrRequiredParams const& astAttrRequireParams ) override;
    virtual std::string visitAttrRequiredAndOptionals( ast::AttrRequiredAndOptionals const& astAttrRequiredAndOptionals) override;
